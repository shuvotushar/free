...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://github.com/shuvo2k4-6/test/blob/main/a.txt"])
	exit(" [*] FACEBOOK :  https://www.facebook.com/shuvo.2k3")
...
def notice():
	...
	runtxt("\033[0;92m ADMIN🧞‍♀️ MESSENGER🔰🥰https://m.me/shuvo.2k3")
	subprocess.check_output(["am", "start", "https://m.me/shuvo.2k3"])
